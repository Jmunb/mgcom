    ...
    <div class="app" v-bind:class="{cpa_link:isCPAPage, cpa_target:isTargetPage, app__showbg:showBg, app__showhm:showHm}">
        ...
        <header>
            <router-link to="/" class="logo" data-cost="Р0,66">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="19.1rem" height="3.8rem" viewBox="0 0 191.02 38" enable-background="new 0 0 191.02 38" xml:space="preserve">
                    <g class="logo--first-letter">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0,0.626c2.265,0,4.33-0.091,6.37,0.06
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M75.022,8.325c-2.136,1.227-4.058,2.335-5.974,3.435
